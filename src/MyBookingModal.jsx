...
export default function MyBookingModal({
  ...
  const fetchMyBooking = async () => {
    const response = await axios.get(
      "https://booking-online-node.onrender.com/mybookings?username=" + username
    );
  ...
  const handleCancel = async (bookingId) => {
    const response = await axios.post("https://booking-online-node.onrender.com/cancelBooking", {
      bookingId,
    });
