    ...
    if (modalType === "login") {
      if (formState.username.length && formState.password.length) {
        const response = await axios.post(
          `https://booking-online-node.onrender.com/login?username=${formState.username}&password=${formState.password}`
        );
      ...
      if (handleValidation()) {
        const response = await axios.post(
          "https://booking-online-node.onrender.com/registration",
          {
            ...formState,
          }
        );
